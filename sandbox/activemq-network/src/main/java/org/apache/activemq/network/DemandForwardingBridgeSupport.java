...
import org.apache.activemq.legacy.broker.region.AbstractRegion;
import org.apache.activemq.legacy.broker.region.RegionBroker;
import org.apache.activemq.legacy.broker.region.Subscription;
import org.apache.activemq.transport.*;
import org.apache.activemq.transport.FutureResponse;
import org.apache.activemq.transport.RequestCallback;
...
public abstract class DemandForwardingBridgeSupport implements NetworkBridge, BrokerServiceAware {
    ...
    public DemandForwardingBridgeSupport(NetworkBridgeConfiguration configuration, Transport localBroker, Transport remoteBroker) {
        ...
        this.remoteBroker = new ResponseCorrelator(remoteBroker);
    }
                ...
                if (command.isMessageDispatch()) {
                    ...
                    if (sub != null && md.getMessage()!=null) {
                        ...
                        if (!message.isResponseRequired()) {
                            ...
                            RequestCallback<Response> callback = new RequestCallback<Response>() {
                            ...
                            remoteBroker.request(message, callback);
                        }
