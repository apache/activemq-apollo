...
public class ActiveMQXAConnectionFactoryTest extends CombinationTestSupport {
    ...
    public void testIsSameRM() throws URISyntaxException, JMSException, XAException {
        ...
        ActiveMQXAConnectionFactory cf1 = new ActiveMQXAConnectionFactory("vm://localhost?broker=jaxb:classpath:non-persistent-activemq.xml");
        XAConnection connection1 = (XAConnection)cf1.createConnection();
        XASession session1 = connection1.createXASession();
        XAResource resource1 = session1.getXAResource();
        
        ActiveMQXAConnectionFactory cf2 = new ActiveMQXAConnectionFactory("vm://localhost?broker=jaxb:classpath:non-persistent-activemq.xml");
